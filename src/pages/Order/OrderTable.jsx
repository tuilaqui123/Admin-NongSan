                                ...
                                {orderList.map((ele, index) => {
                                    return (
                                        <tr
                                            key={index}
                                            onClick={() => {
                                                handleChildSelectBreadcrumb(ele._id)
                                        ...
                                        >
                                            ...
                                            <td className="flex justify-center items-center py-2">
                                                <div className="text-left">
                                                    <p className="font-bold">Họ tên: <span className="font-normal">{ele.customer.name}</span></p>
                                                    <p className="font-bold">Số điện thoại: <span className="font-normal">{ele.customer.phone}</span></p>
                                                </div>
                                            </td>
                                            <td className="font-bold text-[#7dc642]">{formatNumber(ele.intoMoney)}đ</td>
